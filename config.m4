...
if test "$PHP_DEEPTRACE" != "no"; then
	...
	PHP_NEW_EXTENSION(DeepTrace, DeepTrace.c DeepTrace_misc.c DeepTrace_exit_handler.c DeepTrace_functions.c DeepTrace_class.c DeepTrace_constants.c, $ext_shared)
fi